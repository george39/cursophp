<!--25 editar datos de la propiedad -->
          ...
          <div class="row">
            <div class="col s6">
              <select id="estado" name="estado" required="">
                <!--25 para seleccionar un nuevo municipio -->
                <?php
                  ...
                  ?>
                ?>
                <!--para que se cargue el mismo estado que tenia  -->
            ...
            <div class="col s6">
              <div class="res_estado">
                <!--para que se muestre el mismo municipio que tenia -->
